...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Administrar docente</li>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="nuevoDocente" placeholder="Ingresar nombres" required>
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <option value="" id="nuevoTipodoc"></option>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="number" min="0" class="form-control input-lg" name="nuevoCodigo" placeholder="Ingresar codigo" required>
...
<!-- ENTRADA PARA EL TIPO_DOCUMENTO -->
...
<div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="editarTipodoc" id="editarTipodoc" required>
              </div>
